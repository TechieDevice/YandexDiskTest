                    ...
                    while (reader.Read())
                    {
                        if (reader.IsStartElement())
                        {
                            switch (reader.Name)
                            {
                                ...
                                case "d:creationdate":
                                    reader.Read();
                                    if (reader.Value != "") itemInfo.CreationDate = DateTime.Parse(reader.Value);
                                    break;
                                case "d:getlastmodified":
                                    reader.Read();
                                    if (reader.Value != "") itemInfo.LastModified = DateTime.Parse(reader.Value);
                                    break;
                                case "d:displayname":
                                    reader.Read();
                                ...
                                case "d:getcontentlength":
                                    reader.Read();
                                    if (reader.Value != "") itemInfo.ContentLength = int.Parse(reader.Value);
                                    break;
